...
export function OrgSwitcher() {
  ...
  return (
    <DropdownMenu>
      ...
      >
        <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-sm bg-accent/15 text-[0.7rem] font-metric font-medium text-accent shadow-[inset_0_0_0_1px_hsl(var(--accent)/0.3)]">
          {active.initial}
        </div>
      ...
      <DropdownMenuContent align="start" className="w-[260px]">
        ...
        {orgs.map((org) => (
          ...
          >
            <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-sm bg-elevated text-[0.65rem] font-metric text-ink-muted shadow-hairline">
              {org.initial}
            </div>
            <div className="min-w-0 flex-1">
