      ...
      <div className="relative flex flex-1 flex-col justify-between px-10 py-10 lg:px-16">
        ...
        >
          <div className="mb-10">
            ...
            <h1 className="text-center font-display text-[2.4rem] leading-[1.02] tracking-tightest">
              Bem-vindo de volta.
            </h1>
            <p className="mt-3 text-center text-[0.9375rem] leading-relaxed text-ink-muted">
          ...
          <div className="space-y-3">
            <div>
              <label
                htmlFor="login-email"
                className="mb-1.5 block text-2xs font-medium uppercase tracking-[0.14em] text-ink-dim"
              >
                Email corporativo
              </label>
            ...
            <div>
              <label
                ...
                className="mb-1.5 flex items-center justify-between text-2xs font-medium uppercase tracking-[0.14em] text-ink-dim"
              >
                Senha
                <button
                  type="button"
          ...
          <div className="relative my-6 flex items-center">
            ...
            <span className="mx-3 text-2xs uppercase tracking-[0.14em] text-ink-dim">ou</span>
            <span className="h-px flex-1 bg-hairline" />
          </div>
          ...
          <div className="relative flex h-full flex-col justify-between p-12">
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                <div className="relative h-10 w-10 rounded-full shadow-hairline">
                ...
                <div className="font-metric text-xs tabular-nums text-ink-muted">
            ...
            <div className="grid grid-cols-3 gap-8 pt-8 shadow-[inset_0_1px_0_0_hsl(var(--hairline)/0.5)]">
              {[
                ...
                <div key={m.u}>
                  <div className="font-metric text-[1.5rem] tabular-nums leading-none text-ink">
                    {m.k}
                  </div>
