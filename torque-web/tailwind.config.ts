  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'glass-sm': '0 1px 2px 0 rgb(0 0 0 / 0.04), 0 1px 3px 0 rgb(0 0 0 / 0.02)',
        'glass-md': '0 4px 16px -2px rgb(0 0 0 / 0.06), 0 1px 2px 0 rgb(0 0 0 / 0.03)',
        'neu-hover':
          '0 4px 16px -4px rgb(0 0 0 / 0.08), inset 0 1px 0 0 hsl(var(--hairline) / 0.3)',
        'neu-focus': '0 0 0 1px hsl(var(--accent) / 0.5), 0 0 12px -2px hsl(var(--accent) / 0.15)',
        'btn-primary':
      ...
      backgroundImage: {
        ...
        'dot-grid': 'radial-gradient(hsl(var(--hairline)) 1px, transparent 1px)',
        'fade-top': 'linear-gradient(to bottom, hsl(var(--bg)) 0%, transparent 100%)',
        'fade-bottom': 'linear-gradient(to top, hsl(var(--bg)) 0%, transparent 100%)',
      },
      keyframes: {
        'fade-in': {
      ...
      animation: {
        ...
        'caret-blink': 'caret-blink 1.06s cubic-bezier(0.65, 0, 0.35, 1) infinite',
      },
    },
  },
  plugins: [animate],
